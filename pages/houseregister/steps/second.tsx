      ...
      <HouseRegister>
        <div className="flex flex-row justify-between w-5/6">
          <h3 className="text-3xl font-medium">
            Zoekt u samen met <br /> een partner?
          </h3>
          <HelpSection />
        </div>
        ...
        <p className="font-light text-base text-gray-400 pb-10 mt-3">
            ...
            allebei ingeschreven staat als woningzoekende. <br /> U kunt
            daardoor reageren op woningen die passend zijn bij het gezamenlijke
                ...
                <div>
                  ...
                  {initialsInput.current.length > 5 && (
                    <>
                      ...
                      U moet hier uw initialen invullen. Mogelijk vult u nu uw voornaam in.
                      </small>
                    </>
                  )}
                </div>
              ...
              <div className="basis-3/4">
                <div className="mt-0  w-full flex flex-row gap-5 mb-10">
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <label className="text-sm font-medium text-gray-900 ml-2 block">
                      Mijn adres is {localStorage.getItem('street')} {localStorage.getItem('housenumber')}
                    </label>
                  </div>
        ...
        <div className="grid grid-cols-2 justify-items-start mt-0 pb-8">
          ...
          <div className="flex flex-row justify-end w-4/6 items-end">
            {loading ? (
              ...
              <RegisterStepButton text="Volgende stap" action={handleSubmit} />
            )}
          </div>
        </div>
      </HouseRegister>
